...
zero reasoning text -- Trajectory Consistency correctly scored that 0.0. A general
...
Trajectory Consistency/Log-completeness scores IS itself suspicious, whether or not
...
class RewardHackingScanner(WP3Evaluator):
    ...
    def evaluate_composite(
        ...
        trajectory_consistency_result: EvaluationResult,
        ...
        Args:
            ...
            trajectory_consistency_result: output of TrajectoryConsistencyEvaluator.evaluate()
        ...
        grounding_scores = [trajectory_consistency_result.score]
        ...
        return EvaluationResult(
            ...
            explanation=(
                ...
                f"{self.grounding_threshold}). Trajectory Consistency: {trajectory_consistency_result.explanation}"
            ),
            is_success=False,
            metadata={
                "min_grounding_score": min_grounding,
                "trajectory_consistency_score": trajectory_consistency_result.score,
    ...
    def evaluate(self, input) -> EvaluationResult:  # pragma: no cover
        raise NotImplementedError(
            ...
            "Call evaluate_composite(reported_success, trajectory_consistency_result, "
